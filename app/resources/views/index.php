...
<?php require_once \App\Application::VIEW_PATH . '/modules/head.php'?>
...
<section class="featured spad">
    <div class="container">
        ...
        <div class="row featured__filter">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables category-<?= $product->category_id ?>">
...
<!-- Js Plugins -->
<?php require_once \App\Application::VIEW_PATH . '/modules/js.php'?>
